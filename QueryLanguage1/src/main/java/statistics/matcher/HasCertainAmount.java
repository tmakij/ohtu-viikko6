...
abstract class HasCertainAmount implements Matcher {

    private final int value;
    private final String fieldName;
    private final IntegerComparator comparator;

    protected HasCertainAmount(int value, String category, IntegerComparator comparator) {
        this.value = value;
    ...
    public boolean matches(Player p) {
        try {
            ...
            return comparator.compareFirstToSecond(playersValue, value);
